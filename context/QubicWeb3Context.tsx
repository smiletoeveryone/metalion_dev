...
const contractAddress = "0x0EC6a15";
//const contractAddress = "0x0EC6a1578b73E6a562c471C0a33944cBaB8A431f"; //this is the default one
...
const qubicConnector = new QubicConnector({
  ...
  walletUrl: process.env.host as string, //"wallet.prod.qubics.org",
});
